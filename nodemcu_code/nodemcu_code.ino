...
String simpan = "http://192.168.3.7/water-filtering/data/save?pH=";
...
void kirim_database() {
  if ((WiFiMulti.run() == WL_CONNECTED))
  {
    Serial.println(simpan + (String) ph + "&ppm=" + (String) ppm + "&debit=" + (String) debit);

    Serial.println();
    
    http.begin( simpan + (String) ph + "&ppm=" + (String) ppm + "&debit=" + (String) debit);
